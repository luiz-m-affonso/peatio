...
describe API::V2::Account::Balances, type: :request do
  ...
  let(:response_body) { { 'currency' => 'eth', 'balance' => '30.5', 'locked' => '0.0', 'deposit_address' => nil, 'deposit_addresses' => [] } }
    ...
    context 'all balances' do
      ...
      it 'returns current user balances' do
        ...
        expect(result).to contain_exactly(
                              { 'currency' => 'btc', 'balance' => '5.0', 'locked' => '5.0', 'deposit_address' => nil, 'deposit_addresses' => [] },
                              { 'currency' => 'eth', 'balance' => '30.5', 'locked' => '0.0', 'deposit_address' => nil, 'deposit_addresses' => [] },
                              { 'currency' => 'usd', 'balance' => '0.0', 'locked' => '0.0' },
                              { 'currency' => 'trst', 'balance' => '0.0', 'locked' => '0.0', 'deposit_address' => nil, 'deposit_addresses' => [] },
                              { 'currency' => 'ring', 'balance' => '0.0', 'locked' => '0.0', 'deposit_address' => nil, 'deposit_addresses' => [] },
